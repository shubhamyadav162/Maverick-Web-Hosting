...
export const DIGITAL_PRODUCTS_DATA: ServiceProduct[] = [
  {
    id: 'dns-propagation-ping-10',
    title: 'Instant DNS & Latency Health Probe',
    tagline: '60-second automated health scan',
    description: 'Automated global DNS propagation validation, SSL handshake latency test, and HTTP/HTTPS uptime probe across 8 global points of presence with instant status report.',
    deliverables: [
      'Multi-region DNS propagation check',
      'SSL handshake & cipher validation',
      'TCP/HTTP latency response report',
      'Instant PDF health certificate',
    ],
    price: 10,
    iconName: 'Globe',
  },
  {
    id: 'database-query-tuning-501',
    title: 'Database Query Tuning & Index Optimization',
    tagline: 'Query profiling & slow log analysis',
    description: 'In-depth analysis of database slow query logs, missing index recommendations, and connection pool tuning for PostgreSQL, MySQL, or MongoDB workloads.',
    deliverables: [
      'Slow query profiling & explain plan audit',
      'Compound & partial index recommendations',
  ...
  {
    id: 'waf-firewall-ruleset-550',
    title: 'Cloudflare WAF & Layer-7 Firewall Ruleset',
    tagline: 'Anti-scraping & bot rate limiting',
    description: 'Configuration of enterprise-grade Layer-7 web application firewall rules, bad bot challenges, geographical rate-limiting, and SQL injection / XSS shield filters.',
    deliverables: [
      'Custom Layer-7 WAF security rules',
      'Bot challenge & credential stuffing shield',
      'API endpoint rate-limiting directives',
      'Security audit & deployment signoff',
    ],
    price: 550,
    iconName: 'Workflow',
  },
  {
    id: 'server-maintenance-retainer-1000',
    title: 'Monthly Server Maintenance & Patch Retainer',
    tagline: 'Continuous security & uptime watch',
    description: 'Monthly proactive Linux kernel patching, package upgrades, disk health monitoring, automated log rotations, and priority emergency recovery coverage.',
    deliverables: [
      'Monthly security patch deployment',
      'Automated log rotation & disk cleanup',
      '24/7 uptime ping alerting',
  ...
  {
    id: 'nginx-reverse-proxy-1500',
    title: 'Nginx Reverse Proxy & Header Hardening',
    tagline: 'High-throughput proxy setup',
    description: 'Complete production setup of Nginx reverse proxy with automated SSL certificate renewal, Gzip/Brotli compression, CSP/HSTS header injection, and connection pooling.',
    deliverables: [
      'Optimized Nginx worker process config',
  ...
  {
    id: 'custom-webhook-module-3000',
    title: 'HMAC Webhook Dispatcher & API Integration',
    tagline: 'Cryptographically secured webhooks',
    description: 'End-to-end development of custom HMAC-SHA256 authenticated webhook notification system, asynchronous event dispatch queues, and automated retry mechanism.',
    deliverables: [
      'HMAC-SHA256 webhook generator',
      'Asynchronous event queue dispatcher',
  ...
  {
    id: 'enterprise-cloud-cluster-20000',
    title: 'Enterprise Cloud Infrastructure Cluster',
    tagline: 'Dedicated multi-node cluster deployment',
    description: 'Production-ready multi-node cloud cluster deployment with automated load balancing, Redis caching layer, isolated private networking, and 24/7 DevOps SLA monitoring.',
    deliverables: [
      'Multi-node cloud server orchestration',
      'High-availability load balancer & SSL wildcard',
      'Automated encrypted backup pipeline',
      'Dedicated 24/7 DevOps SLA response',
    ],
    price: 20000,
    iconName: 'Server',
  },
  {
    id: 'cloud-api-gateway-2000',
    title: 'High-Performance API Gateway & Reverse Proxy Setup',
    tagline: 'Nginx / Envoy traffic orchestration',
    description: 'Custom configuration of high-throughput API reverse proxy, SSL termination, rate-limiting policies, and automated upstream load distribution.',
    deliverables: [
      'Nginx / Envoy reverse proxy configuration',
      'Automated SSL termination & HTTP/2 setup',
      'Granular IP rate-limiting & DDoS mitigation',
      'Upstream health checks & failover policies',
    ],
    price: 2000,
    iconName: 'Server',
  },
  {
    id: 'fintech-core-microservices-50000',
    title: 'FinTech Core Microservices & Ledger Framework',
    tagline: 'Multi-service event-driven transaction ledger',
    description: 'Distributed ledger microservice architecture designed for ultra-low latency transaction processing, double-entry bookkeeping, and immutable audit logs.',
    deliverables: [
      'Distributed event-driven transaction ledger',
      'Double-entry bookkeeping engine with ACID compliance',
      'Asynchronous message bus (Kafka/RabbitMQ) pipeline',
      'Comprehensive financial audit trails & reporting',
    ],
    price: 50000,
    iconName: 'Box',
  },
  {
    id: 'enterprise-payment-switch-75000',
    title: 'Enterprise Payment Switch & Multi-Acquirer Routing Engine',
    tagline: 'Intelligent failover & high-volume routing',
    description: 'Mission-critical payment switch infrastructure featuring dynamic smart routing across acquirers, automated cascade failover, biometric UPI intent dispatch, and sub-second settlement hooks.',
    deliverables: [
      'Multi-acquirer smart routing & cascade failover engine',
      'Deep UPI Intent, Dynamic QR & Netbanking gateway bridges',
      'Cryptographic webhook validation with zero-drop queuing',
      'Real-time automated reconciliation & dispute telemetry',
    ],
    price: 75000,
    iconName: 'Cpu',
  },
  {
    id: 'high-frequency-settlement-engine-80000',
    title: 'High-Frequency Transaction & Settlement Engine',
    tagline: 'Sub-millisecond ledger matching & payout pipeline',
    description: 'Enterprise-grade financial transaction processing pipeline optimized for high-throughput batching, real-time nodal account settlements, automated UTR matching, and instant callback dispatches.',
    deliverables: [
      'Sub-millisecond order matching & ledger state machine',
      'Real-time automated nodal payout & settlement scheduler',
      'Automated bank statement parsing & UTR reconciliation',
      'SOC2 compliant encrypted audit vaults & cold storage',
    ],
    price: 80000,
    iconName: 'Workflow',
  },
  {
    id: 'cloud-banking-infrastructure-85000',
    title: 'Dedicated Cloud FinTech Suite & Merchant Isolation Platform',
    tagline: 'Multi-tenant isolated banking & payments infrastructure',
    description: 'End-to-end multi-tenant merchant isolation platform with dedicated database schemas, isolated cryptographic vaults, merchant-scoped API keys, and custom white-label dashboard instances.',
    deliverables: [
      'Multi-tenant isolated database tenancy & schema segregation',
      'Dedicated hardware security module (HSM) key vaulting',
      'White-label partner dashboard with analytics & CSV exports',
      'Comprehensive penetration test certification & compliance dossier',
    ],
    price: 85000,
    iconName: 'Server',
  },
  {
    id: 'enterprise-core-fintech-cluster-100000',
    title: 'Enterprise Core FinTech Platform & High-Volume Infrastructure',
    tagline: 'Complete turnkey neo-banking & payment ecosystem',
    description: 'Complete enterprise-scale turnkey fintech architecture delivering high-throughput transaction processing (up to 20,000 TPS), bank-grade resilience, multi-region failover, 24/7 dedicated DevOps SLA, and full source code handover.',
    deliverables: [
      'Turnkey core payment platform & distributed microservices cluster',
      'Multi-region high-availability failover with 99.99% uptime SLA',
      'Real-time fraud prevention, velocity controls & risk telemetry',
      'Full custom source code handover with 1-year enterprise support',
    ],
    price: 100000,
    iconName: 'Globe',
  },
